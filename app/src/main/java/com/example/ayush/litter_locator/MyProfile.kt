...
class MyProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dpname?.setText(Datahelper.car.wasteHname)
       db.qfun()
        val txt = "Points: "+Datahelper.car.pnts
...
//            db.storePic(Datahelper.car.wasteHname,Datahelper.car.picuri)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == GALLERY){
            ...
            dp?.setImageURI(cameraUri)
                ...
                db.storePics(Datahelper.car.wasteHname, Datahelper.car.picuri)
            }
        }
    }
        ...
        Intent(MediaStore.ACTION_IMAGE_CAPTURE).also { takePictureIntent ->
            ...
            takePictureIntent.resolveActivity(packageManager)?.also {
                ...
                val photoFile: File? = try {
                    ...
                    Toast.makeText(this, "Problem is here", Toast.LENGTH_SHORT).show()
                    this.finish()
                    null
                }
                ...
                photoFile?.also {
                    ...
                    cameraUri = photoURI
                    UploadWaste.tran.picUri = photoURI
